...
def inserir_dados_iniciais(cursor, conn):
    ...
    cursor.execute('''
        INSERT INTO configuracoes (nome_barbearia, telefone_contato, whatsapp_contato, endereco)
        VALUES (?, ?, ?, ?)
    ''', ('Barbearia Premium', '(11) 3333-4444', '11333344444', 'Rua das Flores, 123 - Centro'))
